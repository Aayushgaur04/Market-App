...
public class MainActivity extends AppCompatActivity  implements itemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item item1 = new Item(R.drawable.fruit, "Fruits","Fresh Fruits From the gardens");
        ...
        Item item5 = new Item(R.drawable.milk, "Dairy","Milk and Dairy Products");
